...
(function($opal) {
  ...
  $opal.add_stubs(['$append_path', '$expand_path', '$use_gem']);
  ;
  (($a = $scope.Opal) == null ? $opal.cm('Opal') : $a).$append_path((($a = $scope.File) == null ? $opal.cm('File') : $a).$expand_path("../../../opal", "opal/browser"));
  return (($a = $scope.Opal) == null ? $opal.cm('Opal') : $a).$use_gem("paggio");
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/opal/browser.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
